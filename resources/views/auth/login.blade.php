        ...
        <div class="row">
            <div class="col-md-4 d-flex row ms-0 pe-0">
                ...
                <p class="text-white text-center">
                    ...
                    labore dolore, iure quibusdam porro, impedit magnam eaque? Ipsam neque nam quas. Cumque, enim.
                    Eveniet, ipsum!
                </p>
            </div>
            <div class="col-md-8">
                <div class="card">
                    ...
                    <form action="{{ route('login') }}" method="post" class="m-4 col-md-8">
                        @csrf
                        ...
                        <div class="row mb-3 pt-5">
                            ...
                            <div class="col-md-6">
                                <p class="mt-3">don't have an account? <a href="{{ route('register') }}">Register</a>
                                </p>
                            </div>
                        </div>
